function About() {
  return (
    <div>
      <h1 className="text-center text-2xl font-medium my-10">درباره ی ما </h1>
      ...
      <div className="text-center my-10 flex flex-col gap-3">
        <span>شماره تماس : 09001234567</span>

        <span> org@gmail.com : ایمیل </span>

        <span> org-page : instagram </span>
      </div>
    </div>
  );
}
